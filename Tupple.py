...
Q: Write a program to copy elements 44 and 55 from the following tuple into a new tuple.
...
Q: Given is a nested tuple. Write a program to modify the first item (22) of a list inside a following tuple to 222
